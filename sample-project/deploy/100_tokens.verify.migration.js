...
// Verification table is needed to verify more than one contract at once.
...
module.exports = async (verifier) => {
  // To verify multiple instances at one, call this function:
  await verifier.verifyBatch(verificationTable);

  // The same operation, but using `verify` function for a single contract

  // const tokenBalance = await TokenBalance.at("0xBfDf22f5b3Aba8Dec8492B02b1225BFAcef82C5B");
  // await verifier.verifySingle(tokenBalance);

  // const erc20 = await ERC20.at("0xd05e8e8c48BF56af13dfDE244dE19050FaCf9B35");
  // await verifier.verifySingle(erc20, "Token1", "SWT1", 18);
};
