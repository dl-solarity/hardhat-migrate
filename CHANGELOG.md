...
- Recognize Hardhat 3's typed already-verified and explorer-unavailable errors, preserving legitimate reruns and provider fallback without accepting arbitrary message substrings. Preserve structured error causes through migration error wrappers.
